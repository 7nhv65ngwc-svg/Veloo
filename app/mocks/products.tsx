...
export const PRODUCTS: Array<IProduct> = [
    {
        id: 1,
        photo: "https://http2.mlstatic.com/D_Q_NP_673000-MLA109740530955_032026-F.webp",
        categoryID: 1,
        name: "Pneu Aro 15 185/60R15 84H F-600 Firestone",
        description: ` Aquaplanagem: Ranhuras eficientes que escoam a água, garantindo aderência e estabilidade em pistas molhadas.
    ...
    },
    {
        id: 2,
        categoryID: 2,
        photo: "https://http2.mlstatic.com/D_NQ_NP_2X_977639-MLB108811095592_032026-F.webp",
    ...
    {
        id: 3,
        photo: "https://http2.mlstatic.com/D_NQ_NP_2X_657043-MLB89102577641_082025-F-kit-capa-de-chuva-roupa-conjunto-para-motoqueiro-reforcada.webp",
        categoryID: 3,
    ...
    {
        id: 5,
        photo: "https://http2.mlstatic.com/D_NQ_NP_2X_971864-MLA91925160023_092025-F.webp",
        categoryID: 5,
        name: "Console Playstation 5 Slim Edição Digital 825 Gb",
        description: `A Console Playstation 5 Slim Edição Digital 825 GB 
        é a escolha perfeita para os amantes de jogos que buscam uma experiência imersiva e de alta performance. 
        Com um design elegante na cor branca, esta console de mesa combina potência e estilo, ideal para qualquer ambiente.`,
        sellerID: 3,
        price: Math.floor(Math.random() * (1000 - 100 + 1)) + 100,
        rating: Math.floor(Math.random() * (5 - 1 + 1)) + 1
    },
    {
        id: 6,
        photo: "https://http2.mlstatic.com/D_NQ_NP_2X_655403-MLA99494582030_112025-F.webp",
        categoryID: 5,
    ...
    {
        id: 7,
        photo: "https://electrolux.vtexassets.com/arquivos/ids/288205-1000-1000?v=639045978439200000&width=1000&height=1000&aspect=true&format=auto",
        categoryID: 7,
    ...
    {
        id: 8,
        photo: "https://electrolux.vtexassets.com/arquivos/ids/266943-800-800?v=638729964542400000&width=800&height=800&aspect=true&format=auto",
        categoryID: 8,
